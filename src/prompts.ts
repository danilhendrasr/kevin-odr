...
export function prompt_clarifyWithUser(messages: BaseMessage[], date: string) {
  return `
...
export function prompt_transformMessagesIntoTopic(
...
export function prompt_summarizeWebpage(webpageContent: string, date: string) {
  return `
...
export function prompt_researchAgent(date: string) {
  return `
...
export function prompt_compressResearch(date: string) {
  return `
...
export function humanPrompt_compressResearch(researchTopic: string) {
  return `
...
export function prompt_researchAgentWithMcp(date: string) {
  return `
...
export function prompt_leadResearcher(
  date: string,
...
- **Limit tool calls** - Always stop after ${maxIterations} tool calls to think_tool and ConductResearch if you cannot find the right sources
</Hard Limits>
...
export function prompt_finalReportGeneration(
